...
[task_local]
#女神价到抽奖机
10 9 * * * jd_spnvjd.js, tag=女神价到抽奖机, enabled=true
 */
const $ = new Env('女神价到抽奖机');
const notify = $.isNode() ? require('./sendNotify') : '';
//Node.js用户请在jdCookie.js处填写京东ck;
const jdCookieNode = $.isNode() ? require('./jdCookie.js') : '';
let jdNotify = true;//是否关闭通知，false打开通知推送，true关闭通知推送
$.configCodeArr = ['d82abd6d08c948a08fa87958430eb638', '02f742eb50cc4e2dbf98d6adc53bc492'];
$.urlCodes = ['47qob8cnh96GeqphcRJ7Hk2Y3DLd', '4ZocDBKbsGTxFHQyPzUfat9S1Sv6'];
...
!(async () => {
    for (let t = 0; t < $.configCodeArr.length; t++) {
        $.configCode = $.configCodeArr[t];
        console.log('开始活动' + $.configCode);
        console.log('入口下拉：https://prodev.m.jd.com/mall/active/' + $.urlCodes[t] + '/index.html')
        if (!cookiesArr[0]) {
