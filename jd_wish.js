...
let appIdArr = ["1EFNUwqeO","1EFNVyqeH","1FFVQyqw","1EFRWxKuG","1E1xZy6s","1EFRXxg"];
let appNameArr = ["互动抽豪礼","京东电器","1111点心动","许愿抽好礼","PLUS生活特权","闪购盲盒"];
let appId, appName;
$.shareCode = [];
if ($.isNode()) {
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.githubusercontent.com/zspro/updateTeam/main/shareCodes/wish.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/zspro/updateTeam@main/shareCodes/wish.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/zspro/updateTeam@main/shareCodes/wish.json')
  }
