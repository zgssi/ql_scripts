...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.githubusercontent.com/zspro/updateTeam/main/shareCodes/jxhb.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/zspro/updateTeam@main/shareCodes/jxhb.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
