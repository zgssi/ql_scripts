...
!(async () => {
  ...
  $.res = await getAuthorShareCode('https://raw.githubusercontent.com/zspro/updateTeam/main/shareCodes/jxmc.json')
  if (!$.res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/zspro/updateTeam@main/shareCodes/jxmc.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    $.res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/zspro/updateTeam@main/shareCodes/jxmc.json')
  }
