## 直连
```
ql repo https://github.com/zspro/ql_scripts_new.git "jd_|jx_|sendNotify.js" "backup" "ql|sendNotify|jdCookie|USER_AGENTS|ShareCodes|JDSignValidator|JDJRValidator_Aaron|sign_graphics_validate"
```
